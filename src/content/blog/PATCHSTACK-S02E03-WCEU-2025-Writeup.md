...
pubDate: "Jun 08 2025"
heroImage: "../../assets/PATCHSTACK-S02E03-WCEU-2025/patchstack_s02e03_wceu.png"
tags: ["Web", "Wordpress"]
---

### **Scoreboard Freeze**

![Scoreboard Freeze](../../assets/PATCHSTACK-S02E03-WCEU-2025/Scoreboard.png)
...
![Grep wp_handle_upload](../../assets/PATCHSTACK-S02E03-WCEU-2025/CustomImport-grep.png)
...
Run the solver:
![Solver](../../assets/PATCHSTACK-S02E03-WCEU-2025/CustomImport-solver.png)

Read flag in /flag\*:
![Flag](../../assets/PATCHSTACK-S02E03-WCEU-2025/CustomImport-readflag.png)
...
![Validate SQLi](../../assets/PATCHSTACK-S02E03-WCEU-2025/WhatIsMagic-validatesqli.png)
...
![Flag](../../assets/PATCHSTACK-S02E03-WCEU-2025/WhatIsMagic-flag.png)
...
![Keyword](../../assets/PATCHSTACK-S02E03-WCEU-2025/Orangy-keyword.png)

When opened, there is a PoC that is full of the same as this question.
![POC](../../assets/PATCHSTACK-S02E03-WCEU-2025/Orangy-poc.png)

Just do it right away on this challenge.

**Exploit:**\
![Exploit](../../assets/PATCHSTACK-S02E03-WCEU-2025/Orangy-exploit.png)
...
![Generator](../../assets/PATCHSTACK-S02E03-WCEU-2025/EverestExpedition-generator.png)

Make a request to the REST API containing the payload and the flag is obtained.
![Flag](../../assets/PATCHSTACK-S02E03-WCEU-2025/EverestExpedition-flag.png)
...
![Valid User](../../assets/PATCHSTACK-S02E03-WCEU-2025/GhostPost-validuser.png)

Sign in with the user and grab the cookie.
![Sign In](../../assets/PATCHSTACK-S02E03-WCEU-2025/GhostPost-signin.png)

Access the "http://18.140.17.89:9180/ghost-view/" page with the session cookie obtained, then the flag is obtained.
![Flag](../../assets/PATCHSTACK-S02E03-WCEU-2025/GhostPost-flag.png)
...
![Register Page](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-registerpage.png)
...
![Register Success](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-registersuccess.png)

Log in using a new user.
![Login](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-login.png)

Promote the role to Contributor.
![Promote Role](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-promote.png)

Create post dengan shortcode [preview_file path=’.. /.. /.. /.. /flag.txt’].
![Create Post](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-createpost.png)

Submit Post, then view page and flag obtained.
![Flag](../../assets/PATCHSTACK-S02E03-WCEU-2025/OpenContrib-flag.png)
