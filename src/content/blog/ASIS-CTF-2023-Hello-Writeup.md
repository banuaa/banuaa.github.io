...
description: "ASIS CTF 2023 - Hello [Web]"
pubDate: "Sept 23 2023"
heroImage: "../../assets/ASIS-CTF-2023-Hello/ASISCTF2023_logo.png"
tags: ["Web"]
---
...
![Hello](../../assets/ASIS-CTF-2023-Hello/ASISCTF2023_hello1.png)
...
const server = Bun.serve({
  ...
  fetch(req) {
    ...
    if (pname.startsWith(`/${secret}`)) {
      ...
      return new Response(
        `did you know i can read files?? amazing right,,, maybe try /${secret}/read/?file=/proc/self/cmdline`,
      );
    }
    return;
  },
