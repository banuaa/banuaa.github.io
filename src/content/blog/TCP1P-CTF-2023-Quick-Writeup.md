...
pubDate: "Oct 09 2023"
heroImage: "../../assets/TCP1P-CTF-2023/TCP1PCTF2023_logo.png"
tags: ["Web", "Reversing", "Forensic", "Misc"]
---
...
**Main Function:**
![Main Function](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_SubjectEncallment1.png)

**Secret Function:**
![Secret Function](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_SubjectEncallment2.png)

**printFlag Function:**\
![printFlag Function](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_SubjectEncallment3.png)

**Solver:**
![Flag](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_SubjectEncallment4.png)
...
![Flag](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_UnSecure1.png)
...
![Flag](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_ASimpleWebsite1.png)
...
![Flag Split](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_hideandsplit1.png)

**Solver:**\
Simply read the flag[0-9].txt:flag[0-9] file and convert to png with command **'cat _:flag_ | xxd -r -p > flag.png'**.

![Flag](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_hideandsplit2.png)
...
**Solver:**
![Random Number](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_GuessMyNumber1.png)
![flag](../../assets/TCP1P-CTF-2023/TCP1PCTF2023_GuessMyNumber2.png)
